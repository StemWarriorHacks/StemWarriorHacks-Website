	...
	return (
		<div id='home' className='h-screen'>
			...
			<div className='flex flex-col justify-center items-center h-3/5 w-11/12 md:w-4/5 my-10 mx-auto'>
				<p className='text-5xl md:text-8xl font-bold mb-4 text-dark w-full text-center'>
					Stem Warrior Hacks
				</p>
				<p className='text-2xl font-semibold md:text-3xl mb-4'>
					November 5th - 8th, 2021
				</p>
				<div className='flex flex-col md:flex-row justify-center md:justify-between items-center w-4/5 md:w-3/6'>
					<a href={urls.devpost}>
